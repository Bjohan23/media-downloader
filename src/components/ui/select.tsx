  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Base styles
          "bg-popover text-popover-foreground relative z-[99999] shadow-lg",
          // Animations
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          // Slide animations based on position
          "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
          // Sizing and overflow
          "max-h-[300px] min-w-[var(--radix-select-trigger-width)] overflow-x-hidden overflow-y-auto",
          // Border and radius
          "rounded-md border",
          // Mobile specific - use fixed positioning
          "data-[state=open]:fixed data-[state=open]:inset-auto",
          // Position specific
          position === "popper" &&
